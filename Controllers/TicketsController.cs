...
namespace ticketApp.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,DateSubmitted,Deadline,Title,Email,ApplicationName,Description,Type,ClientName,ClientPriority,OurPriority,AppointedTo,Status,Attachments")] Ticket ticket)
        {
